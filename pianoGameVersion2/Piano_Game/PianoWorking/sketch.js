...
var arr1 = ["t","t", "o","o", "p","p", "o", "i","i", "u","u", "y","y", "t", "o","o","i","i", "u","u","y","o","o","i","i","u","u","y","t","t","o","o","p","p","o","i","i","u","u","y","y","t"];
var arr2 = ["a", "s", "d", "t", "y", "u", "i", "o", "p", "f", "s", "d", "t", "y", "u", "i", "o", "p", "f"];

var listOfSongs = [arr1, arr2];
...
var recordKey = [];
    ...
    function keyPressed() {
      if(keyCode == "32" && j < listOfSongs.length){
        j=j+1;
        // for(var i = 0; i < listOfSongs.length; i++){
          keyPrint = listOfSongs[j];
